...
public class Test2 extends Activity implements OnLocationUpdatedListener, OnActivityUpdatedListener, OnGeofencingTransitionListener {
...
//        geofenceText = (TextView) findViewById(R.id.geofence_text);
    ...
    private void showLast() {
        ...
        if (lastLocation != null) {
            Toast.makeText(this, String.format("[From Cache] Latitude %.6f, Longitude %.6f",
        ...
        if (detectedActivity != null) {
            Toast.makeText(this, String.format("[From Cache] Activity %s with %d%% confidence",
...
//    }
            ...
            SmartLocation.with(this).geocoding().reverse(location, new OnReverseGeocodingListener() {
                ...
                public void onAddressResolved(Location original, List<Address> results) {
                    if (results.size() > 0) {
                        ...
                        Toast.makeText(Test2.this, builder.toString(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
        } else {
    ...
    private void showActivity(DetectedActivity detectedActivity) {
        if (detectedActivity != null) {
            Toast.makeText(this, String.format("Activity %s with %d%% confidence",
                    getNameFromType(detectedActivity),
                    detectedActivity.getConfidence()), Toast.LENGTH_SHORT).show();
        } else {
    ...
    private void showGeofence(Geofence geofence, int transitionType) {
        if (geofence != null) {
            Toast.makeText(this,"Transition " + getTransitionNameFromType(transitionType) + " for Geofence with id = " + geofence.getRequestId(), Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(this, "Null activity", Toast.LENGTH_SHORT).show();
        }
    }
